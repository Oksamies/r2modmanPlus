...
export const dateStartQueryParam = z.object({
  key: z.literal("date_start"),
  value: z.string().optional(),
});

export const dateEndQueryParam = z.object({
  key: z.literal("date_end"),
  value: z.string().optional(),
});

export const createdStartQueryParam = z.object({
  key: z.literal("created_start"),
  value: z.string().optional(),
});

export const createdEndQueryParam = z.object({
  key: z.literal("created_end"),
  value: z.string().optional(),
});
